...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , write_throttling_disk_utilization_threshold(this, "write_throttling_disk_utilization_threshold", liveness::LiveUpdate, value_status::Used, 0.98, "Disk utilization level above which all mutation writes to user table are rejected")
